...
namespace SparCraft {
    ...
    public:
        ...
        enum {
            Player_One = 0, Player_Two = 1, Player_None = 2, Player_Both = 3, Size
        };
    ...
    public:
        ...
        enum {
            AlphaBeta, IDAlphaBeta, MiniMax, Size
        };
    ...
    public:
        ...
        enum {
            ...
            PortfolioGreedySearchDeep, PortfolioOnlineEvolutionDeep, ABPOESimetricoDeep, ABPOELimitDeep, None, Size
        };
    ...
    public:
        ...
        enum {
            Default, RootNode, SoloNode, FirstSimNode, SecondSimNode, Size
        };
    ...
    public:
        ...
        enum {
            Random, Alternate, Not_Alternate, Size
        };
