...
class PortfolioGreedySearchDavePlusShort
{
protected:
...
public:
    ...
    PortfolioGreedySearchDavePlusShort(const IDType & player, const IDType & enemyScript, const size_t & iter, const size_t & responses, const size_t & timeLimit);
