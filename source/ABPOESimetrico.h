...
namespace SparCraft {
    ...
    class ABPOESimetrico : public Player {
    ...
    public:
        ABPOESimetrico(const IDType & playerID);
        ABPOESimetrico(const IDType & playerID , int numUnitsAB, std::string controlAbstraction);
        ~ABPOESimetrico();
