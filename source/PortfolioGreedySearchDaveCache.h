...
namespace SparCraft {    
    ...
    class PortfolioGreedySearchDaveCache {
    ...
    public:
        ...
        PortfolioGreedySearchDaveCache(const IDType & player, const IDType & enemyScript, const size_t & iter, const size_t & responses, const size_t & timeLimit);
        ~PortfolioGreedySearchDaveCache();
