...
namespace SparCraft {
    ...
    class ManagerMoreLife : public ManagerAbstraction{
        Position _centroide;
    public:
        ManagerMoreLife(const IDType & playerID, int numUnits);
        virtual ~ManagerMoreLife();
    ...
    private:
        ...
        IDType getIDUnitMoreLife(GameState & state);
    };
