...
namespace SparCraft {
    ...
    class GenerationClassForDeep : public Player {
        ...
        int controlPartidas;
    public:
        GenerationClassForDeep(const IDType & playerID);
        GenerationClassForDeep(const IDType & playerID, int numUnitsAB);
        void getMoves(GameState & state, const MoveArray & moves, std::vector<Action> & moveVec);

        IDType getType() {
            return PlayerModels::GenerationClassForDeep;
        }
