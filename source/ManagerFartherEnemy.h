...
namespace SparCraft {
    ...
    class ManagerFartherEnemy : public ManagerAbstraction{
        Position _centroide;
    public:
        ManagerFartherEnemy(const IDType & playerID, int numUnits);
        virtual ~ManagerFartherEnemy();
    ...
    private:
        ...
        IDType getIDUnitMoreFarther(GameState & state);
    };
